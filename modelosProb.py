...
# = AUXILIARES
# combinacao
"""Retorna uma combinação de n tomada de k a k"""
# stringfy_combinacao
"""Retorna uma representação de combinação: n!/k!(n-k)!"""
#
# = MODELOS
# modelo_uniforme_discreto
"""Retorna a probabilidade de ocorrência de uma variável entre k chances iguais de ocorrência (1/k)"""
# modelo_binomial
"""Retorna a pSucesso de uma variável com chance fixa de ocorrência/sucesso (1/k)"""
# usar_ensaios_de_Bernoulli
"""Retorna a probabilidade de ocorrência de sucessosDesejados com dada pSucesso em n repeticoes"""
# realizar_ensaios_de_Bernoulli
"""Mostra no terminal a p de ocorrência de sucessosDesejados com dada pSucesso em n repeticoes"""
# simular_ensaios_de_bernoulli
"""Retorna uma simução de ensaios de Bernoulli com Hacker-statics simulando 100000 ensaios"""
# usar_modelo_geometrico
"""Retorna a probabilidade de ocorrência com pSucesso se dar apenas na enésima repetição"""
# realizar_modelo_geometrico
"""Mostra no terminal a p de ocorrência com pSucesso se dar apenas na enésima repetição"""
# usar_modelo_poisson
"""Retorna a probabilidade de ocorrência de uma lambdaTaxaOcorrencias em kOcorrencias"""
# realizar_modelo_poisson
"""Mostra no terminal a p de ocorrência de uma lambdaTaxaOcorrencias em kOcorrencias"""
# usar_modelo_hipergeometrico
"""Retorna a probabilidade de ocorrência numa amostra a partir de dados da pop"""
# realizar_modelo_hipergeometrico
"""Mostra no terminal a p de ocorrência numa amostra a partir de dados da pop"""
...
def modelo_binomial(k):
    ...
    # A variável só pode ter valores de sucesso ou fracasso
...
exemplo_Bernoulli_5 = "\n\n\n\n\nPara 20 pessoas, cada uma com 0.85 de chance de negativo, qual a probabilidade de no máximo uma testar negativo?"
print(exemplo_Bernoulli_5)
print(f"Probabilidade de 0 testar positivo {realizar_ensaios_de_Bernoulli(0.15, 0, 20): .8f}")
print(f"Probabilidade de 1 testar positivo {realizar_ensaios_de_Bernoulli(0.15, 1, 20): .8f}")
print(f"Probabilidade = {usar_ensaios_de_Bernoulli(0.15, 0, 20) + usar_ensaios_de_Bernoulli(0.15, 1, 20)} \n\n\n")
...
def realizar_modelo_geometrico(pSucesso, kEnsaiosPrecedemSucesso):
    print(f"Px = {pSucesso  : .4f}(1-{pSucesso : .4f})^{kEnsaiosPrecedemSucesso} = {pSucesso*((1-pSucesso)**kEnsaiosPrecedemSucesso) : .6f} ")
...
plt.show()
exemplo_modelo_geometrico3 = "\n\n\n\n\nPara 20 pessoas, cada uma com 0.15 de chance de positivo, qual a probabilidade a quarta testar positivo?"
print(exemplo_modelo_geometrico3)
realizar_modelo_geometrico(0.15, 4)
...
exemplo_modelo_hipergeometrico2 = "\nNuma caixa de 10 lâmpadas, 2 são defeituosas. Extraída uma amostra de 4 lâmpadas, determine a probabilidade de haver pelo menos duas defeituosas"